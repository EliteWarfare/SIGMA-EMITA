...
life_fatigue = 0; // Kill that fucking ebola
life_canVote = false;
life_voted = false;
...
//[shortVar,reward]
life_illegal_items = [["heroinu",2200],["heroinp",3500],["cocaine",2500],["cocainep",4500],["marijuana",3000],["turtle",9000],["blastingcharge",10000],["boltcutter",1000]];
