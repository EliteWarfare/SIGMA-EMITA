...
switch (life_veh_shop select 0) do
{
	...
	case "dodge_shop": {_ret = license_civ_driver;};
	case "lambo_shop": {_ret = license_civ_driver;};
	case "chevy_shop": {_ret = license_civ_driver;};
	case "porsche_shop": {_ret = license_civ_driver;};
	case "lykan_shop": {_ret = license_civ_driver;};
	case "veyron_shop": {_ret = license_civ_driver;};
	case "mclaren_shop": {_ret = license_civ_driver;};
	case "audi_shop": {_ret = license_civ_driver;};
	case "ford_shop": {_ret = license_civ_driver;};
	...
	case "swat_car": {_ret = true;};
	case "fbi_car": {_ret = true;};
	case "cop_ship": 
	{
