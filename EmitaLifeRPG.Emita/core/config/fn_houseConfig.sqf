...
switch (true) do {
	...
	case (_house in ["Land_i_House_Big_01_V1_F","Land_i_House_Big_01_V2_F","Land_HouseDoubleAL","Land_HouseDoubleAL2","Land_i_House_Big_01_V3_F"]): {[2200000,4]};
	case (_house in ["Land_i_Garage_V1_F","Land_i_Garage_V2_F"]): {[500000,0]};
	case (_house in ["Land_i_House_Small_01_V1_F","Land_HouseA1_L","Land_HouseC1_L","Land_HouseB1","Land_i_House_Small_01_V2_F","Land_i_House_Small_01_V3_F"]): {[1050000,2]};
