...
/*
	...
	Edited by Outlaw [credit goes to MidgetGrimm since he wrote the code]

	Description:
	Blah blah.
*/
private["_group","_hideout","_action","_cpRate","_cP","_progressBar","_title","_titleText","_ui","_flagTexture","_gangName"];
_hideout = (nearestObjects[getPosATL player,["Barrack2","Land_A_Castle_Wall2_30","Land_Ss_hanger"],100]) select 0;
